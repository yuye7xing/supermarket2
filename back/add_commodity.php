...
$e_sql="SELECT * FROM `m_commodity`,`m_type`,`m_suppliers` where m_commodity.mt_id=m_type.mt_id and m_commodity.ms_id=m_suppliers.ms_id";
if($type=="全部"||$type==""){
...
include 'html/add_commodity.html';
